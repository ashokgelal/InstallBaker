...
namespace InstallBaker_UnitTests.MyToolWindowTest
{
    ...
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new InstallBakerPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(InstallBakerPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
